// This file is adapted from an existing flutter/material component in Flutter 2.5.1.
// Source: https://github.com/flutter/flutter/blob/master/packages/flutter/lib/src/cupertino/sliding_segmented_control.dart

// A modification of the material package's CupertinoSlidingSegmentedControl to expose
// radius & shadow.
...
// BoxShadow for the thumb.
// Colors extracted from https://developer.apple.com/design/resources/.
const List<BoxShadow> _thumbShadow = <BoxShadow>[
  BoxShadow(
...
class SlidingSegmentedControl<T> extends StatefulWidget {
  ...
  SlidingSegmentedControl({
    ...
    this.parentRadius = const Radius.circular(_kCornerRadius),
    this.thumbRadius = _kThumbRadius,
    this.thumbShadow = _thumbShadow,
...
class _SegmentedControlState<T> extends State<SlidingSegmentedControl<T>>
    with TickerProviderStateMixin<SlidingSegmentedControl<T>> {
  ...
  void initState() {
    ...
    thumbScaleController = AnimationController(
        duration: _kSpringAnimationDuration, value: 0, vsync: this);
    thumbScaleAnimation = thumbScaleController
        .drive(Tween<double>(begin: 1, end: _kMinThumbScale));
  ...
  @override
  void didUpdateWidget(SlidingSegmentedControl<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
  ...
  Widget build(BuildContext context) {
    ...
    return UnconstrainedBox(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.all(widget.parentRadius),
        ...
        child: AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget child) {
            return _SegmentedControlRenderWidget<T>(
              ...
              thumbShadow: widget.thumbShadow,
              state: this,
              children: children,
            );
          },
...
class _RenderSegmentedControl<T> extends RenderBox
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (highlightedChildIndex != null) {
      ...
      _paintThumb(context, offset, thumbRect, thumbRadius, thumbShadow);
    } else {
  ...
  void _paintThumb(PaintingContext context, Offset offset, Rect thumbRect,
      Radius thumbRadius, List<BoxShadow> thumbShadow) {
    final RRect thumbRRect =
        RRect.fromRectAndRadius(thumbRect.shift(offset), thumbRadius);
